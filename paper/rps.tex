...
to one player in case his opponent refuses to open his commitment within a given time frame (two time steps):
\begin{lstlisting}
function finalize() {
...
to ensure that in the initial states the random choices are not yet done.
